...
I found `r nrow(exp[exp$Plasticity!="",])` studies that investigated plasticity, either explicitly setting out to do so or finding it emerge. I'd like to see how plasticity overlaps with other categories.
...
I found `r nrow(exp[exp$IGE!="",])` studies that investigated IGE, either explicitly setting out to do so or finding it emerge. I'd like to see how IGE overlaps with other categories.
...
I found `r nrow(exp[exp$GxE!="",])` studies that investigated GxE effects, either explicitly setting out to do so or finding it emerge. I'd like to see how GxE overlaps with other categories.
...
bp<-barplot(t(catyrs[,!colnames(catyrs)%in%c("Plasticity","Phenotypic.gambit","IGE","GxE")]),
            col=col,las=1,border = NA,axes = FALSE)
legend(x = -1,y=51,c("Personality","Mate choice","Reproduction/Fecundity","Parental Care",
...
![Combined plots](../qgb_data/figs/YearPlots.png)